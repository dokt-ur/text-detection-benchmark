...
For example:
```shell
python test.py config/fast/tt/fast_base_tt_800_finetune_ic17mlt.py pretrained/fast_base_tt_800_finetune_ic17mlt.pth --ema --cpu
python test.py config/fast/ic17mlt/fast_small_ic17mlt_640.py pretrained/fast_small_ic17mlt_640.pth --ema --cpu
cd eval/
sh eval_tt.sh
```
It should give:
